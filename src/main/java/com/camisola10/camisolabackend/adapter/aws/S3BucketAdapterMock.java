...
class S3BucketAdapterMock implements CloudStorage {
    ...
    private static final Image MOCK_IMAGE = new Image(Image.ImageId.create(), "mockImage", "https://camisola-backend.s3-eu-west-1.amazonaws.com/images/defaultshirt.png");
